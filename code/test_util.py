...
def test_all_case2(vnet,resnet, image_list, num_classes, patch_size=(96, 96, 96), stride_xy=16, stride_z=16, save_result=True, test_save_path=None, preproc_fn=None):
    total_metric = 0.0
    for image_path in tqdm(image_list):
...
def test_single_case2(vnet, image=None, stride_xy=None, stride_z=None, patch_size=None, num_classes=1):
    w, h, d = image.shape
